...
class _BerandaPageState extends State<BerandaPage> {
  ...
  Future<void> _loadCounts() async {
    try {
      final done = await DatabaseHelper.instance.getTaskCountByStatus(1);
      final pending = await DatabaseHelper.instance.getTaskCountByStatus(0);
      setState(() {
        tugasSelesai = done;
  ...
  Future<void> _refreshAfterReturn() async {
    await Future.wait([_loadChartData(), _loadCounts()]);
  }
